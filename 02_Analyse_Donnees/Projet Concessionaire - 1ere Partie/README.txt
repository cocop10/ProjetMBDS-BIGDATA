...
-Un dossier "R- Oracle DB", contentant le script de connexion à Oracle via R, le script de chargement des fichiers .csv sur Oracle et 
les commandes sql qui permette le nettoyage des données.
