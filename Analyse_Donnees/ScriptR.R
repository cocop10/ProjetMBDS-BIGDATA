                                             ...
                                             ifelse(immatriculations$longueur=="moyenne" & immatriculations$puissance >=55 & immatriculations$puissance <= 100 & immatriculations$nbPlaces== 5,"routiere",
                                                    ifelse(immatriculations$longueur=="moyenne" & immatriculations$puissance >=100 & immatriculations$puissance <= 140 & immatriculations$nbPlaces== 5,"routiere sportive",
                                                           ifelse(immatriculations$longueur=="moyenne" & immatriculations$puissance > 140 & immatriculations$nbPlaces== 5,"routiere ultra sportive" ,
                                                                  ifelse( immatriculations$longueur=="trÃ¨s longue" & immatriculations$puissance >=55 & immatriculations$puissance <= 250 & immatriculations$nbPlaces== 5,"berline" ,
                                                                          ifelse( immatriculations$longueur=="trÃ¨s longue" & immatriculations$puissance >=250 & immatriculations$puissance <= 350 & immatriculations$nbPlaces== 5,"berline sportive" ,
                                                                                  ifelse( immatriculations$longueur=="trÃ¨s longue" & immatriculations$puissance > 350 & immatriculations$nbPlaces== 5,"berline ultra sportive" ,
...
#Seules les catÃ©gories, et les donnÃ©es "humaines" sur les clients nous importent
...
#Duplication du data set, pour ajout d'une colonne catÃ©gorie taux ultÃ©rieurement
...
#clients_immatriculations_EA : sÃ©lection des 29014 premiÃ¨res lignes de clients_immatriculations.(70% de donnÃ©es)"
clients_immatriculations_EA <- clients_immatriculations[1:68773,]

#ENSEMBLE DE TEST
#clients_immatriculations_ET : sÃ©lection des  derniÃ¨res lignes de clients_immatriculations.(30% de donnÃ©es)"
...
#CrÃ©ation de categorie de taux
...
clients_immatriculations_taux$cateTaux<- ifelse(clients_immatriculations_taux$TAUX < 420 ,"Faible",
                                           ifelse(clients_immatriculations_taux$TAUX <607.1, "Moyen",
                                                  ifelse(clients_immatriculations_taux$TAUX <823, "Elevé", "Très elevé")))
...
marketing$cateTaux<- ifelse(marketing$TAUX < 420 ,"Faible",
                                                ifelse(marketing$TAUX <607.1, "Moyen",
                                                       ifelse(marketing$TAUX <823, "Elevée", "Très Elevé")))
