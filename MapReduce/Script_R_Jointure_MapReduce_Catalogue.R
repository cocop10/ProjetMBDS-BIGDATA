#import des fichiers
co2mapreduce <- read.csv("C:/Users/c.poirier/Desktop/new/ProjetVoiture/DATA/Mapreduce.csv", header = FALSE, sep = ",", dec = ".")
catalogue <- read.csv("C:/Users/c.poirier/Desktop/new/ProjetVoiture/DATA/Catalogue.csv", header = TRUE, sep = ",", dec = ".")
View(co2mapreduce)
View(catalogue)
